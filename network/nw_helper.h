...
{
    nw_ip_status_change_callback_func_t *cb_func; /**< IP address status change callback function */
    void *arg;                                    /**< User data */
...
{
    nw_ip_version_t version; /**< IP version */
 ...
 * @return none
 */
void nw_ip_initialize_status_change_callback(nw_ip_status_change_callback_t *info, nw_ip_status_change_callback_func_t *cbf, void *arg);
 ...
 */
bool nw_ip_get_ipv4_address(nw_ip_interface_t iface, nw_ip_address_t *addr);
 ...
 * @return none
 */
void nw_ip_register_status_change_callback(nw_ip_interface_t iface, nw_ip_status_change_callback_t *info);
 ...
 * @return none
 */
void nw_ip_unregister_status_change_callback(nw_ip_interface_t iface, nw_ip_status_change_callback_t *info);
 ...
 *
 * @param[in]  iface      : Pointer to network interface object
 * @param[in, out] list   : Pointer to @ref nw_arp_cache_entry_t array
