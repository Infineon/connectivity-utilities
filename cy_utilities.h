...
* \mainpage Overview
********************************************************************************
* The connectivity utilities library is a collection of general purpose middleware utilities
*
* The following utilities are bundled:
*
* * Logging 
*
* * Worker thread
...
* * String conversion
*
* Several Cypress connectivity middleware libraries shall depend on this library
*
* Refer to the API reference guide for details
*
* \defgroup group_utils Common middleware utilities
*
* \defgroup group_utils_enums Middleware utilities enumerated types
* @ingroup group_utils
*
...
* @ingroup group_utils
* \defgroup group_string_func String conversion functions
